...
/** Extracts the tag name from a push event's `ref` (e.g. "refs/tags/v1.2.3" -> "v1.2.3"), or undefined if it's not a tag push. */
...
/** Matches a tag name against a list of glob patterns (e.g. "v*"), the same semantics as GitHub Actions' on.push.tags. */
