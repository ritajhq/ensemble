...
const REASONS = [
  {
    ...
    body:
      "Each app is built through a configured kit, which can be reused, inspected, customized and replaced across apps and teams, no more polluting config files or scripts in your workspace.",
  },
  {
    title: "Agility through adaptability",
    body:
      "The build, pack, and deploy kits are pluggable, so you can adapt to new frameworks, runtimes, and deployment targets without rewriting your apps.",
  },
  {
    title: "Complete control",
    body:
      "Run your apps locally or remotely, in development or production, with a single CLI that orchestrates the whole lifecycle.",
  },
  {
    title: "Context an agent can read",
    body:
      "Because every concern has a name and a home, an AI agent can find the file that matters without being handed the whole repo. Kits and delivery manifests give it a contract to follow instead of a guess to make.",
  },
];
