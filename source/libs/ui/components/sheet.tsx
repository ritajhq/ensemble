    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        className={cn(
          ...
          canResize && "transition-none data-[side=left]:sm:max-w-none data-[side=right]:sm:max-w-none",
          className
        )}
      ...
      >
        {canResize && (
          <div
            ...
            className={cn(
              "absolute inset-y-0 z-10 w-1 cursor-col-resize touch-none hover:bg-ring/50 active:bg-ring",
